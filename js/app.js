(() => {
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            document.querySelectorAll(".work__spollers").forEach((function(workSpoller) {
                const details = workSpoller.querySelector("details");
                if (details) details.addEventListener("toggle", (function(event) {
                    workSpoller.classList.toggle("spoller-color", event.target.hasAttribute("open"));
                }));
            }));
        }));
        window["FLS"] = true;
